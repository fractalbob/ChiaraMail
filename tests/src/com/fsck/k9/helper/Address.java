...
public class Address extends TestCase {
    ...
    public void testParseWithMissingEmail() {
        com.chiaramail.chiaramailforandroid.mail.Address[] addresses =  com.chiaramail.chiaramailforandroid.mail.Address.parse("NAME ONLY");
    ...
    public void testPraseWithValidEmail() {
        com.chiaramail.chiaramailforandroid.mail.Address[] addresses =  com.chiaramail.chiaramailforandroid.mail.Address.parse("Max Mustermann <maxmuster@mann.com>");
        assertEquals(1, addresses.length);
    ...
    public void testPraseWithValidEmailMulti() {
        com.chiaramail.chiaramailforandroid.mail.Address[] addresses =  com.chiaramail.chiaramailforandroid.mail.Address.parse("lorem@ipsum.us,mark@twain.com");
